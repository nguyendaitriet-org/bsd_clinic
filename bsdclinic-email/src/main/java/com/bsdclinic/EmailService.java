...
public class EmailService {
    ...
    public SendEmailResponse sendSimpleEmail(String toEmail, String subject, String body) {
        try {
    ...
    public SendEmailResponse sendHtmlEmail(String toEmail, String subject, String htmlBody) {
        try {
            SendEmailRequest request = SendEmailRequest.builder()
                    .source(fromEmail)
                    .destination(dest -> dest.toAddresses(toEmail))
    ...
    public SendEmailResponse sendTemplatedEmail(String toEmail, String subject,
